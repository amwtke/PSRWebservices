...
//		ArrayList<Record> _records = op.GetRecords("sd");
...
//	}
	public ArrayList<Fact> GetFacts(String recordNo)
		...
		if (recordNo != null) {
			...
			try {
				...
				String sql = "select * from PSR_FACT where RECORDNO=\'"+recordNo+"\'";
	...
	public ArrayList<RecordResult> GetResults(String recordNo)
		...
		if (recordNo != null) {
			...
			try {
				st = JDBCUtil.GetConnection().createStatement();
				String sql = "select * from PSR_RECORDRESULT where RECORDNO=\'"+recordNo+"\'";
				rs = st.executeQuery(sql);
				if(rs!=null)
				{
	...
	public ArrayList<Record> GetRecords(String recordNo)
		...
		if (recordNo != null) {
			...
			try {
				st = JDBCUtil.GetConnection().createStatement();
				String sql = "select * from PSR_RECORD where RECORDNO=\'"+recordNo+"\'";
				rs = st.executeQuery(sql);
				if(rs!=null)
				{
